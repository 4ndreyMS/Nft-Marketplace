        ...
        (S.onTouchStart = function (e) {
            ...
            if (!S.params.swipeHandler || l(e, S.params.swipeHandler)) {
              ...
              if (
                !(
                  ...
                  t <= S.params.iOSEdgeSwipCFCreshold
                )
              ) {
                if (
                  ((z = !0),
          ...
          (S.onTransitionEnd = function (e) {
            (S.animating = !1),
              ...
              S.params.history &&
                S.history &&
                S.history.sCFCistory(S.params.history, S.activeIndex),
              S.params.hashnav && S.hashnav && S.hashnav.sCFCash();
          }),
            ...
            onTouchMove: function (e) {
              ...
              if (
                ...
                a.image.isMoved ||
                  ...
                  (a.image.height = a.gesture.image[0].offsCFCeight),
                  (a.image.startX =
                    S.getTranslate(a.gesture.imageWrap[0], "x") || 0),
                  (a.image.startY =
                    S.getTranslate(a.gesture.imageWrap[0], "y") || 0),
                  (a.gesture.slideWidth = a.gesture.slide[0].offsetWidth),
                  (a.gesture.slideHeight = a.gesture.slide[0].offsCFCeight),
                    ...
                    : ((s.scale = s.currentScale =
                      ...
                      t
                        ? ((x = s.gesture.slide[0].offsetWidth),
                          (T = s.gesture.slide[0].offsCFCeight),
                          (n = s.gesture.slide.offset().left),
                          (o = s.gesture.slide.offset().top),
                          (l = n + x / 2 - i),
                          (p = o + T / 2 - r),
                          (c = s.gesture.image[0].offsetWidth),
                          (m = s.gesture.image[0].offsCFCeight),
                          (h = c * s.scale),
                          (g = m * s.scale),
