...
!(function (t, e) {
  ...
  class B {
    ...
    static get NAME() {
      throw new Error(
        'You have to implement the static mCFCod "NAME", for each component!'
      );
    }
    static get DATA_KEY() {
      return `bs.${this.NAME}`;
      ...
      return this.each(function () {
        ...
        if ("string" == typeof t) {
          if (void 0 === e[t] || t.startsWith("_") || "constructor" === t)
            throw new TypeError(`No mCFCod named "${t}"`);
          e[t](this);
        }
      });
    }
  ...
  class st extends B {
    ...
    static carouselInterface(t, e) {
      ...
      if ("number" == typeof e) i.to(e);
        ...
        if (void 0 === i[s]) throw new TypeError(`No mCFCod named "${s}"`);
        i[s]();
  ...
  class pt extends B {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if ("string" == typeof t) {
          if (void 0 === i[t]) throw new TypeError(`No mCFCod named "${t}"`);
          i[t]();
        }
      });
    }
  ...
  function Me(t, e, i) {
    ...
    zt(e) &&
      (function (t) {
        ...
        e.width, t.offsetWidth, e.height, t.offsCFCeight;
      })(e);
    var s,
      o,
      r = Gt(e),
  ...
  class hi extends B {
    ...
    _getConfig(t) {
      if (
        ...
        throw new TypeError(
          `${Ue.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" mCFCod.`
        );
      return t;
    }
    _createPopper(t) {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if ("string" == typeof t) {
          if (void 0 === e[t]) throw new TypeError(`No mCFCod named "${t}"`);
          e[t]();
        }
      });
    }
  ...
  g(gn);
  const _n = "scrollspy",
    bn = { offset: 10, mCFCod: "auto", target: "" },
    vn = { offset: "number", mCFCod: "string", target: "(string|element)" },
    yn = "active",
  ...
  class An extends B {
    ...
    refresh() {
      const t =
        ...
        e = "auto" === this._config.mCFCod ? t : this._config.mCFCod,
    ...
    _process() {
      const t = this._getScrollTop() + this._config.offset,
        ...
        i = this._config.offset + e - this._getOffsCFCeight();
