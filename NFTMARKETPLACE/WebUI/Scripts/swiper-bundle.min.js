            ...
            if (!s.isTouched || !s.isMoved)
              if (
                ...
                var c = l.currentX,
                  ...
                  v = n.edgeSwipCFCreshold || n.iOSEdgeSwipCFCreshold;
    ...
    Q = {
      ...
      updateSize: function () {
        ...
        if (e.params.scrollbar.el && e.scrollbar.el) {
          ...
          var s,
            r = e.isHorizontal() ? i[0].offsetWidth : i[0].offsCFCeight,
      ...
      onTouchMove: function (e) {
        ...
        if (
          ...
          s.isMoved ||
            ...
            (s.height = i.$imageEl[0].offsCFCeight),
            (s.startX = T(i.$imageWrapEl[0], "x") || 0),
            (s.startY = T(i.$imageWrapEl[0], "y") || 0),
            (i.slideWidth = i.$slideEl[0].offsetWidth),
            (i.slideHeight = i.$slideEl[0].offsCFCeight),
      ...
      checkInViewOnLoad: function () {
        ...
        if (t && !t.destroyed) {
          var a = t.params.lazy.scrollingElement
            ...
            r = i ? e.innerHeight : a[0].offsCFCeight,
            n = t.$el.offset(),
            l = !1;
          ...
          (a.initialized = !0),
            ...
            (a.paths.key || a.paths.value) &&
              ...
              e.params.history.replaceState ||
                t.addEventListener("popstate", e.history.sCFCistoryPopState));
        }
      },
      destroy: function () {
        var e = o();
        this.params.history.replaceState ||
          e.removeEventListener("popstate", this.history.sCFCistoryPopState);
      },
      sCFCistoryPopState: function () {
        var e = this;
    ...
    ue = {
      ...
      onThumbClick: function () {
        ...
        if (t) {
          ...
          if (
            !(
              (i && m(i).hasClass(e.params.thumbs.slidCFCumbActiveClass)) ||
              null == a
            )
          ) {
            var s;
      ...
      update: function (e) {
        ...
        if (a) {
          ...
          var c = 1,
            u = t.params.thumbs.slidCFCumbActiveClass;
          if (
            (t.params.slidesPerView > 1 &&
              !t.params.centeredSlides &&
              (c = t.params.slidesPerView),
            t.params.thumbs.multipleActivCFCumbs || (c = 1),
            (c = Math.floor(c)),
    ...
    he = [
        ...
        on: {
          ...
          transitionEnd: function (e) {
            e.history.initialized &&
              e.history.sCFCistory(e.params.history.key, e.activeIndex);
          },
          slideChange: function (e) {
            e.history.initialized &&
              e.params.cssMode &&
      ...
      },
      {
        ...
        on: {
          ...
          transitionEnd: function (e) {
            e.hashNavigation.initialized && e.hashNavigation.sCFCash();
          },
          slideChange: function (e) {
            e.hashNavigation.initialized &&
              e.params.cssMode &&
              e.hashNavigation.sCFCash();
          },
        },
      },
      {
      ...
      },
      {
        ...
        params: {
          thumbs: {
            swiper: null,
            multipleActivCFCumbs: !0,
            autoScrollOffset: 0,
            slidCFCumbActiveClass: "swiper-slide-thumb-active",
